...
class App {
  ...
  _toggleElevationField() {
    inputElevation.closest('.form__row').classList.toggle('form__row--hidden'); //inputElevation.closest('.form__row') is the div(parent el with form__row class)
  ...
  _newWorkout(e) {
    ...
    // If workout running, create cyclimg object
    if (type === 'cycling') {
